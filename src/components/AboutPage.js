...
class aboutPage extends Component {
    ...
    render() {
        return (
            <div>
                <section className='fullScreen aboutPage'>
                    <div className="descriptionTop">
                        <span className="textDescriptionPage">
                            <span className="colorVioletBold">About me</span>
                            <span>Say Hello !</span>
                        </span>
                    </div>
                    <div className="contentCenter">
                        <div className="descriptionAbout">
                            <div className="txtDescription">
                                Je suis un développeur <span className="colorWhiteBold">Front-End</span>, qui se spécialise en <i dangerouslySetInnerHTML={{__html: "<svg id='reactSVG' viewBox='-11.5 -10.23174 23 20.46348'><circle cx='0' cy='0' r='2.05' fill='#61dafb'/><g stroke='#61dafb' stroke-width='1' fill='none'><ellipse rx='11' ry='4.2'/><ellipse rx='11' ry='4.2' transform='rotate(60)'/><ellipse rx='11' ry='4.2' transform='rotate(120)'/></g></svg>"}}></i>.
                            </div>
                            <div className="txtDescription">
                                Les nouvelles <span className="colorViolet">expériences</span> et <span className="colorViolet">challenges</span> me motivent.<br/>
                                Si vous avez un nouveau projet ou opportunité, restons en contact !
                            </div>
                        </div>
                        <a href="mailto:sitbon.teddy@gmail.com?Subject=Hello%20Teddy" className="mailLink">teddysitbon<span className="colorViolet">@</span>gmail.com</a>
